return {
...

  {
    ...
    keys = {
      ...
      { "<leader>\\",      "<cmd>FzfLua grep_cword<cr>",                desc = "Grep Word Under Cursor",      mode = { 'n', 'v' } },
      { "<leader>:",       "<cmd>FzfLua command_history<cr>",           desc = "Search Command History" },
      { '<leader>"',       "<cmd>FzfLua registers<cr>",                 desc = "Search Registers",            mode = { 'n', 'v' } },
      ...
      { "<leader>sk",      "<cmd>FzfLua keymaps<cr>",                   desc = "Search Keymaps",              mode = { 'n', 'v' } },
